  ...
  return (
    <form action={handleAction} className="w-full h-full flex flex-col gap-5 justify-center">
      <div className="flex flex-col gap-1">
        ...
        <input className="p-2 border rounded-md border-gray-300 focus:bg-gray-100 focus:border-b-2 focus:outline-none" name="name" type="text" placeholder="Nombre de usuario..." />
      </div>
			<div className="flex flex-col gap-1">
